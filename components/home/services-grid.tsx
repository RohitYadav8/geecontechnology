          ...
          {services.map((service) => (
            <StaggerItem key={service.id}>
              <TiltCard className="group">
                ...
                <div className="relative rounded-2xl bg-gradient-to-br from-transparent via-transparent to-transparent p-[1px] transition-all duration-500 group-hover:from-blue-400/40 group-hover:via-cyan-300/30 group-hover:to-blue-500/40">
                  <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl group-hover:shadow-slate-900/10 dark:border-slate-800 dark:bg-slate-900 dark:group-hover:shadow-black/40">
                    ...
                    <div className="p-6">
                      ...
                      <Link
                        href={service.href}
                        className="group/link mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-[#1a2b4a] transition-colors hover:text-[#0d1830] dark:text-blue-400 dark:hover:text-blue-300"
                      >
                        Read more
                        <ArrowRight
                          size={14}
