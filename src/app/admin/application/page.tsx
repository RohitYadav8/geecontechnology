        ...
        <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <div className="flex flex-1 flex-col">
                ...
                <main className="flex-1 overflow-y-auto p-8">
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Applications</h1>
                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Submissions from the Careers page &ldquo;Submit Your Details&rdquo; form.
                    </p>
                        ...
                        <table className="w-full text-left text-sm">
                            ...
                            <tbody>
                                ...
                                {applications.map((app) => (
                                    <tr key={app.id} className="border-b border-slate-50 last:border-0 dark:border-slate-800">
                                        <td className="px-6 py-4 font-medium text-slate-900 dark:text-white">
                                            {app.firstName} {app.lastName}
                                        </td>
                                        <td className="px-6 py-4 text-slate-500 dark:text-slate-400">{app.email}</td>
                                        <td className="px-6 py-4 text-slate-500 dark:text-slate-400">{app.phone}</td>
